  ...
  'w-fit inline-flex items-center justify-center whitespace-nowrap text-sm rounded-md font-alt font-medium transition-colors disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        pastelBlue: 'bg-blue-100 text-black border border-blue-200 hover:bg-blue-200 hover:text-blue-900',
        pastelPink: 'bg-pink-100 text-black border border-pink-200 hover:bg-pink-200 hover:text-pink-900',
      },
      size: {
        default: 'h-10 px-4',
